...
function record_post_type()
{
    ...
    $args = array(
        ...
        'description'           => __('This represents a record against investments or savings that includes credit details and debit details', 'text_domain'),
        'labels'                => $labels,
        'supports'              => array('title', 'editor'),
        'taxonomies'            => array('category', 'record'),
        'hierarchical'          => false,
        'public'                => true,
        'show_ui'               => true,
        'show_in_menu'          => true,
...
add_action('init', 'record_post_type', 0);
